...
export const aboutData = [
  {
    ...
    heroImage: "/images/about-1000acre.webp",
    heroTitle: "About\nboCHE 1000 Acre",
    ...
    seo: {
      ...
      url: "https://www.boche1000acre.com/about/boche1000acre",
    },
...
Situated in the scenic town of Meppadi within Wayanad district, the property enjoys a prime location known for its cool climate, lush forests, and stunning landscapes. The development aims to transform the region into a premier tourism and entertainment hub.
...
`,
...

  {
    ...
    slug: "bobychemmanurinternationalgroup",
    navTitle: "Boby Chemmanur International Group",
    heroImage: "/images/about-group.webp",
    ...
    seo: {
      ...
      url: "https://www.boche1000acre.com/about/bobychemmanurinternationalgroup",
    },

    content: `
# Boby Chemmanur International Group

Founded as a small jewellery shop in 1863, the group has expanded and evolved over the years. Today, under the leadership of boCHE, the fourth-generation heir, it stands as a globally renowned brand. The group now operates a network of 56 jewellery outlets across India, the USA, and the GCC.
...
Under the brand name "boCHE," the ventures continue to soar on the wings of trust and transparency, expanding into diversified business sectors such as NBFC (Non-Banking Financial Company with Reserve Bank of India License). It has 302 branches all over India, along with tea plantations and factories, resorts, an entertainment park on 1,000 acres, tours and travels, real estate, e-commerce, integrated meat stores, caravan tourism, jewellery manufacturing, garment factory, baby wear, restaurants, clubs, home appliances, breweries, optical lens manufacturing (Rx), insurance, IT, and more.

## Group Companies & Ventures

- Boby Chemmanur International Jewellers  
- boCHE Gold Loan (Chemmanur Credits and Investments Limited)  
- Boby Oxygen Resorts  
- boCHE Tours & Travels  
- Phygicart.com  
- boCHE the Butcher  
...
`,
...

  {
    ...
    heroImage: "/images/about-boche.webp",
    heroTitle: "About\nDr. Boby Chemmanur\n(boCHE)",
...
"When quizzed about his favorite brand, he would only smile and point to his traditional attire — a white mundu (dhoti) and a simple short sleeved top — saying, 'this is the brand I'm carrying now since the last few years.'"
...
The contribution of Dr. Boby Chemmanur to the social services sector assumes immense value in today's world. boCHE is the founder of Life Vision Charitable Trust. He shares the profit of his trade with the poor by starting Poor Homes wherever there are outlets of Chemmanur International Jewelers, providing shelter, food, clothing, and medicines for the needy.
