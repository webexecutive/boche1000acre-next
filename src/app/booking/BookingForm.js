            ...
            <form id="enquiry-form" onSubmit={handleSubmit(onSubmit)} noValidate>
                <div className="border border-gray-400 p-6 rounded-2xl md:p-10 grid md:grid-cols-2 gap-10">
                    ...
                    <div className="space-y-5 relative">
                        ...
                        {/* Check-In and Check-Out Range Picker */}
                        {(() => {
                            const checkinVal = watch("checkin");
                            const checkoutVal = watch("checkout");
                            const parsedCheckin = checkinVal ? safeParse(checkinVal) : null;
                            const parsedCheckout = checkoutVal ? safeParse(checkoutVal) : null;
                            const rangeValue = [parsedCheckin, parsedCheckout].filter(Boolean);
                            ...
                            return (
                                <DatePicker.Root
                                    ...
                                    closeOnSelect={true}
                                    onValueChange={({ value }) => {
                                        const start = value?.[0] ? value[0].toString() : "";
                                        const end = value?.[1] ? value[1].toString() : "";
