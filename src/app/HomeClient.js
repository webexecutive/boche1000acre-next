...
// Derived values — pure functions of viewportWidth, no window access inside them.
// width === 0 means "not measured yet" (SSR / first paint before the resize
// effect runs), so each function returns the large/desktop default in that case.
const getPosterId = (width) => {
    if (width === 0) return 188; // default: large
    if (width <= 640) return 190;   // sm
    if (width <= 1024) return 189;  // md
    return 188;                     // large
};

const getEstateBgId = (width) => {
    if (width === 0) return 191; // default: large
    if (width <= 640) return 193;   // sm
    if (width <= 1024) return 192;  // md
    return 191;                     // lg
};

const getAnimationSrc = (width) => {
    if (width === 0) return "/videos/heroanimationlg.webm";
...
const getLoopSrc = (width) => {
    if (width === 0) return "/videos/hero16x9/index.m3u8";
...
const getSlowConnectionBannerId = (width) => {
    if (width === 0) return 194; // default: lg
...
function HomeClient() {
    ...
    // Single source of truth for viewport width — 0 on the server / before
    // mount, real value after the resize effect below runs. Everything that
    // used to read window.innerWidth directly now derives from this.
    ...
    const videoSrc = getAnimationSrc(viewportWidth);
    ...
    const posterId = getPosterId(viewportWidth);
    ...
    useEffect(() => {
        ...
        import("hls.js").then(({ default: Hls }) => {
            if (cancelled) return;
            cleanupAttach = attachHls(getLoopSrc(viewportWidth), Hls);
        });
        ...
        <>
            ...
            < section className="relative overflow-hidden md:h-180"
                ...
                <div className="hidden md:block absolute inset-0">
                    ...
                    <Image
                        ...
                        onLoad={(e) => { e.currentTarget.previousElementSibling.style.opacity = 0; }}
                    />
            ...
            < section className="bg-[#F7FDE9] py-20" >
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="flex justify-center">
                        <Link href="/stays"><Button size="sm">View All Stays</Button></Link>
                    </div>
                </div>
            </section >
            ...
            < section className="py-20 text-center overflow-hidden bg-[linear-gradient(rgba(254,255,251,0.9),rgba(254,255,251,0.9)),url('/images/restaurantbg-sm.svg')] md:bg-[linear-gradient(rgba(254,255,251,0.9),rgba(254,255,251,0.9)),url('/images/restaurantbg-md.svg')] lg:bg-[linear-gradient(rgba(254,255,251,0.9),rgba(254,255,251,0.9)),url('/images/restaurantbg-lg.svg')] bg-cover bg-center bg-no-repeat" >
                <div className="max-w-7xl relative mx-auto px-4">
                    <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center w-full">
                        ...
                        <div className="order-1 md:order-2 flex flex-col items-center text-center gap-6">
                            ...
                            <div className="flex items-center justify-center gap-6 flex-wrap">
                                <div className="relative h-40 w-[180px]">
                                    <Image
                                        src="/logos/boche-toddypub.webp"
                                        alt="boCHE Toddy Pub Logo"
                                        title="boCHE Toddy Pub Logo"
                                        fill
                                        sizes="180px"
                                ...
                                <div className="relative h-28 w-[180px]">
                                    <Image
                                        src="/logos/boche-bhojanam.webp"
                                        alt="boCHE Bhojanam Logo"
                                        title="boCHE Bhojanam Logo"
                                        fill
                                        sizes="180px"
                                        className="object-contain"
                                    />
                    ...
                    <Image
                        src="/images/bohe-withfood.webp"
                        alt="boCHE Toddy Pub Dining Experience"
                        title="boCHE Toddy Pub Dining Experience"
                        width={600}
                        height={384}
                        className="hidden xl:block absolute -bottom-20 -right-16 h-96 w-auto"
                        style={{ width: "auto" }}
                    />
            ...
            < section className="bg-[#F7FDE9] py-20" >
                <div className="max-w-7xl relative mx-auto px-4">
                    ...
                    <div className="flex justify-center">
                        <Link href="/adventures"><Button size="sm">Know More</Button></Link>
                    </div>
                </div>
            </section >
                ...
                <div className="relative max-w-7xl mx-auto px-6 md:px-8 py-20 text-white flex flex-col items-center space-y-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        <div className="flex flex-col items-center md:items-start text-center md:text-left gap-6">
                            <Image
                                src="/logos/bhoomiputra-logo.webp"
            ...
            < section className="bg-[#F7FDE9] py-20" >
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="flex justify-center mt-8">
                        <Link href="/blog"><Button size="sm">Read All Stories</Button></Link>
                    </div>
                </div>
            </section >
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                        {categories
                            ...
                            .map((cat) => {
                                ...
                                return (
                                    <Link href={`/gallery/${cat.category}`} key={cat.id}>
                ...
                <div className="max-w-5xl mx-auto px-6 text-center">
                    ...
                    >
                        <input
                            ...
                            className="w-full flex-1 px-6 py-3.5 bg-gray-50/50 border  rounded-full focus:outline-none focus:border-black focus:ring-1 focus:ring-black transition disabled:opacity-50"
                        />
                        <Button
                            type="submit"
                            size="md"
